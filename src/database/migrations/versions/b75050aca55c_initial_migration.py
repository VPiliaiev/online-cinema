...
Revision ID: b75050aca55c
Revises: 
Create Date: 2026-03-21 09:21:32.138144
...
def upgrade() -> None:
    ...
    sa.Column('imdb', sa.DECIMAL(precision=3, scale=1), nullable=False),
    sa.Column('meta_score', sa.DECIMAL(precision=4, scale=1), nullable=True),
    ...
    sa.CheckConstraint('imdb >= 0 AND imdb <= 10', name='imdb_range_check'),
    sa.CheckConstraint('votes >= 0', name='votes_positive_check'),
    sa.ForeignKeyConstraint(['certification_id'], ['certifications.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'year', 'time', name='unique_movie_identity')
    )
    ...
    sa.CheckConstraint('value >= 1 AND value <= 10', name='rating_range_check'),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
